# -*- coding: utf-8 -*-
r"""
Deneb command line interface (CLI)
==============
Composed by 4 main commands:
    train       Used to train a machine translation metric.
    score       Uses Deneb to score a list of MT outputs.
...
from deneb.corpora import corpus2download, download_corpus
...
def score(model, source, hypothesis, reference, cuda, batch_size, to_json):
    ...
    click.secho(
        "Deneb system score: {:.3f}".format(sum(scores) / len(scores)), fg="yellow"
    )
