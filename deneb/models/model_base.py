...
Model Base
==============
    Abstract base class used to build new modules inside Deneb.
...
from deneb.models.encoders import Encoder, str2encoder
from deneb.schedulers import str2scheduler
...
class ModelBase(ptl.LightningModule):
    ...
    def _build_model(self) -> ptl.LightningModule:
        ...
        """
        # Compatibility with previous Deneb versions
        if (
