...
from deneb.models.ranking.ranking_base import RankingBase
from deneb.models.utils import move_to_cuda
from torchnlp.utils import collate_tensors


class DenebRanker(RankingBase): # extends ptl.LightningModule
    """
    Deneb Ranker class that uses a pretrained encoder to extract features
