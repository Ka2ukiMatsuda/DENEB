...
==============================
    Abstract base class used to build new ranking systems inside Deneb.
...
from deneb.models.utils import average_pooling, max_pooling
from deneb.modules.scalar_mix import ScalarMixWithDropout
from deneb.metrics import WMTKendall
